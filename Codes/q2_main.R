...
CBG = naiveBayes(x = dataNormTrain[-5], 
...
classResult = as.data.frame(matrix(nrow = length(dataNormTest[[1]]), ncol=2))
names(classResult) = c('target', 'CBG')
classResult$target = dataNormTest$class
classResult$CBG = pred_CBG
